...
- **"fatal: not a git repository"**: You're on a cloud instance without the repository cloned
  - **Solution**: `git clone https://github.com/mkn9/bat.git && cd bat`
...
- **Wrong directory for git operations**: Ensure you're in `/home/ubuntu/bat`
  - **Check**: `pwd` should show the bat directory path
